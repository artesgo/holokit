...
<style lang="scss">
  ...
  .holo-success {
    background: var(--success);
		text-shadow:
			-1px -1px 4px var(--success-lighter),
			 1px -1px 4px var(--success-lighter),
			-1px  1px 4px var(--success-lighter),
			 1px  1px 4px var(--success-lighter),  
			-2px  0   4px var(--success-lighter),
			 2px  0   4px var(--success-lighter),
			 0    2px 4px var(--success-lighter),
			 0   -2px 4px var(--success-lighter);
    &:hover {
  ...
  .holo-warning {
    background: var(--warning);
		text-shadow:
			-1px -1px 4px var(--warning-lighter),
			 1px -1px 4px var(--warning-lighter),
			-1px  1px 4px var(--warning-lighter),
			 1px  1px 4px var(--warning-lighter),  
			-2px  0   4px var(--warning-lighter),
			 2px  0   4px var(--warning-lighter),
			 0    2px 4px var(--warning-lighter),
			 0   -2px 4px var(--warning-lighter);
    &:hover {
  ...
  .holo-info {
    background: var(--info);
		text-shadow:
			-1px -1px 4px var(--info-lighter),
			 1px -1px 4px var(--info-lighter),
			-1px  1px 4px var(--info-lighter),
			 1px  1px 4px var(--info-lighter),  
			-2px  0   4px var(--info-lighter),
			 2px  0   4px var(--info-lighter),
  ...
  .holo-danger {
    ...
    color: white;
		text-shadow:
			-1px -1px 4px var(--danger-darker),
			 1px -1px 4px var(--danger-darker),
			-1px  1px 4px var(--danger-darker),
			 1px  1px 4px var(--danger-darker),  
			-2px  0   4px var(--danger-darker),
			 2px  0   4px var(--danger-darker),
			 0    2px 4px var(--danger-darker),
			 0   -2px 4px var(--danger-darker);
    &:hover {
  ...
  .holo-neutral {
    ...
    color: white;
		text-shadow:
			-1px -1px 4px var(--neutral-darker),
			 1px -1px 4px var(--neutral-darker),
			-1px  1px 4px var(--neutral-darker),
			 1px  1px 4px var(--neutral-darker),  
			-2px  0   4px var(--neutral-darker),
			 2px  0   4px var(--neutral-darker),
			 0    2px 4px var(--neutral-darker),
			 0   -2px 4px var(--neutral-darker);
    &:hover {
